...
public class FlightchangePage extends BasePage {

	public FlightchangePage(WebDriver driver) {
		super(driver);
...
//		dayButtonList.get(day+start-4).click();
	...
	public void inquireRouteNoinformation(String routeNo) throws InterruptedException {
		this.getRouteNoInput().clear();
		System.out.print(routeNo);
		this.getRouteNoInput().sendKeys(routeNo);
		Thread.sleep(1000);
		System.out.print(routeNo+"------");
		this.getInquireButton().click();
	}
	public void inquireRouteDateinformation(int year,int mounth,int day) throws InterruptedException {
