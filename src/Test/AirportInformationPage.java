...
public class AirportInformationPage extends BasePage {

	public AirportInformationPage(WebDriver driver) {
		super(driver);
		// TODO Auto-generated constructor stub
	}
	By fourCodeSelectLocator=By.xpath("/html/body/div[1]/div/section/div/div/div[2]/div/form/div/div[1]/div/div/div/input");
	By threeCodeSelectLocator=By.xpath("/html/body/div[1]/div/section/div/div/div[2]/div/form/div/div[2]/div/div/div/input");
	By inquireButtonLocator=By.xpath("/html/body/div[1]/div/section/div/div/div[2]/div/form/div/div[3]/button");
...
//	}
	...
	public WebElement getThreeCodeSelect() {
		return this.driver.findElement(threeCodeSelectLocator);
	}
	...
	public String inquireFourCode() throws InterruptedException {
		...
		Thread.sleep(5000);
		List<WebElement> fourCodeList =  this.driver.findElement(By.xpath("/html/body/div/div/section/div/div/div[2]/div/form/div/div[1]/div/div/dl")).findElements(By.tagName("dd"));
		Random r=new Random();
