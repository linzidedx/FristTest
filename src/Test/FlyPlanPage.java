...
public class FlyPlanPage extends BasePage {

	public FlyPlanPage(WebDriver driver) {
		super(driver);
	...
	By cNameInputLocator=By.xpath("//*[@id=\"CNAME\"]");
	By flightNoInputLocator=By.xpath("//*[@id=\"FLIGHTNO\"]");
	By planeNoInputLocator=By.xpath("/html/body/div/div/section/div/div/div[2]/div/form/div/div[3]/div/div/div/input");
	By staDateInputLocator=By.xpath("//*[@id=\"startDate\"]");
	By endDateInputLocator=By.xpath("//*[@id=\"endDate\"]");		
	By inquireButtonLocator=By.xpath("/html/body/div/div/section/div/div/div[2]/div/form/div/div[6]/button");
	By noData=By.xpath("/html/body/div/div/section/div/div/div[2]/div/div/div[1]/div[2]/div");
	List<WebElement> planeNoList=this.driver.findElement(By.xpath("/html/body/div/div/section/div/div/div[2]/div/form/div/div[3]/div/div/dl")).findElements(By.tagName("dd"));
	...
	public WebElement getcNameInput() {
		
		return this.driver.findElement(cNameInputLocator);
	}
...
//		dayButtonList.get(day+start-4).click();
	...
	public void inquireNameFlyPlanInformation(String name) throws InterruptedException {
		this.getcNameInput().clear();
		this.getcNameInput().sendKeys(name);
		Thread.sleep(1000);
	...
	public void inquireDateinformation(int sYear,int sMounth,int sDay,int eYear,int eMounth,int eDay) throws InterruptedException {
		...
		Thread.sleep(5000);
		this.getEndDateInput().click();
		Thread.sleep(1000);
		this.setYear(eYear);
		Thread.sleep(1000);
		this.setMounth(eMounth);
		Thread.sleep(1000);
		this.setDay(eYear, eMounth, eDay);
		Thread.sleep(5000);
		//System.out.print(this.getRouteDateInput().getText());
		this.getInquireButton().click();
		//System.out.print(t//RouteDateInput().getText());
	}
	public String inquirePlaneNoInformation() throws InterruptedException {
		this.getflightNoInput().click();
		Thread.sleep(5000);
		Random r=new Random();
