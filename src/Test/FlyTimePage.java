...
public class FlyTimePage extends BasePage {

	public FlyTimePage(WebDriver driver) {
		super(driver);
	...
	By staDateInputLocator=By.xpath("//*[@id=\"staDate\"]");
...
//		dayButtonList.get(day+start-4).click();
	...
	public void inquireNameFlyTimeInformation(String name) throws InterruptedException {
